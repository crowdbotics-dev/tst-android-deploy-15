...
## Project Structure
    ...
    ├── tst_android_deploy_15  # Django project configurations
...
1. Clone this repo and `cd tst_android_deploy_15`
...
2. Clone this repo and `cd tst_android_deploy_15`
